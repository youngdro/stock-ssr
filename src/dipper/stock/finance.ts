...
const finance = { /**
    ...
    getGuideLine: async (code, year) => {
        ...
        return await digger(format(dataSource.stock_guidline.url, code, year), options);
    },
    /**
     * @param {string} code 股票代码
     * @param {string} year 年份
    ...
    getBalanceSheet: async (code, year, company_type) => {
        ...
        return await digger(format(dataSource.stock_balancesheet.url, code, year), options);
    },
    /**
     * @param {string} code 股票代码
     * @param {string} year 年份
    ...
    getProfitStatment: async (code, year, company_type) => {
        ...
        return await digger(format(dataSource.stock_profitstatement.url, code, year), options);
    },
    /**
     * @param {string} code 股票代码
     * @param {string} year 年份
    ...
    getCashFlowStatment: async (code, year, company_type) => {
        ...
        return await digger(format(dataSource.stock_cashflowstatement.url, code, year), options);
    }
}
